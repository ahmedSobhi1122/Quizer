...
class MyTheme{
  ...
  static const navigationBarForeground = ColorRef(Color(0xFFB7A9FD),id: "navigationBarBackground");
  static const navigationBarBackground = ColorRef(Color(0xFFECEBF2),id: "navigationBarForeground");
